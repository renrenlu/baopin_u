...
const ISSUES: Issue[] = [
  ...
  {
    date: "2026-09-04",
    title: "开学囤货：数量感先压满画面，再让使用者自己开口",
    summary: "今天不把这组开学囤货压成一种公式，先对照三条真实路径：一只布丁狗湿巾的满手满桌数量冲击、橙汁妈妈洁面乳的孩子本人提出复购、负二代饲养员仓鼠奶酪的AI拟人化长故事。",
    takeaway: "今天不要从开学囤货倒推固定开头：一只布丁狗用“豪宅感客厅里手掌托着五包湿巾、桌面还堆着多提，口播‘新学期第一件事就是囤小湿巾啊’”；橙汁妈妈用“穿军训服的男孩拿着洁面乳对妈妈说‘你再帮我买两瓶这个吧，我军训出油多’”；负二代饲养员用“AI仓鼠蜷在纸屑里睡觉，旁白说‘小仓鼠这辈子有两次没得选’”。三条分别依赖数量感、使用者开口和拟人化故事，先找最强证据，再决定开场方式。",
    category: "开学囤货",
    topics: ["baby care也来卷了！大品牌的羊毛没理由不薅啊！！孩子开学、出门逛街都用得到，闭…","#青春期 孩子油脂分泌旺盛，小脸变得不光滑了，就不要再用清水洗脸了#袋鼠妈妈#儿童…","#哈基米入眠 #知识科普 #贪吃鼠 #爱吃奶酪的鼠鼠 #吃货鼠鼠"],
    size: "6.6 MB",
    accent: "blue",
  },
  {
    date: "2026-09-05",
    title: "家清个护：把脏污和动作拍具体，产品再进场解决",
    summary: "今天不把这组家清个护压成一种公式，先对照三条真实路径：小羊yoki滴露消毒喷雾的宿舍床铺当场喷洒、二柱子真聪明除螨喷雾的动画恐惧悬念、王一楠彩漂粉的家庭Vlog长故事嵌品。",
    takeaway: "今天不要从家清个护倒推固定开头：小羊yoki用“第一秒掀开宿舍床帘，把两瓶喷雾摆到床上就喷，口播‘有经验的妈妈们消毒喷雾早就准备起来了’”；二柱子真聪明用“动画黑影钻进眼睛爬上床，口播‘能钻进你眼睛里寄生的可怕生物就在你床上’”；王一楠用“夜市里孩子扑进大人怀里，旁白‘云南女演员回老家给亲姐当德华的一天，遭罪’”。三条分别依赖场景动作、恐惧悬念和长故事信任，先找最强证据，再决定开场方式。",
    category: "家清个护",
    topics: ["有经验的妈妈早就备起来了#滴露消毒喷雾 #滴露 #除菌 #学生党必备 #开学","你的床是不是螨虫窝？ 4招自查，中1条就赶紧除！#螨虫 #科普知识 #寄生虫 #沫檬除螨喷…","我家这个娃太费小姨了 #记录真实生活#云南美食#娘家#母婴好物#Vanish渍无踪金装彩…"],
    size: "5.9 MB",
    accent: "peach",
  },
  {
    date: "2026-09-06",
    title: "美妆眼妆：把下笔动作放进超近景，先给结果再教步骤",
    summary: "今天不把这组美妆眼妆压成一种公式，先对照三条真实路径：旺旺大瑶眼线铅笔的参考图加笔尖贴眼、王希楚粉扑的评论区质疑现场自证、蒙妹不染眉膏的推翻旧配色认知。",
    takeaway: "今天不要从美妆眼妆倒推固定开头：旺旺大瑶用“眼部超近景叠放古早妆参考图，口播‘混血精髓其实就是这种半包眼线’”；王希楚用“把黑粉扑怼到脸前，吐槽‘你转行做尿不湿行吗，这么能吸’”；蒙妹不用“手遮一边眉毛做左右对比，推翻‘黑发配黑眉、浅发配黄眉’的旧认知”。三条分别依赖参考对照、质疑自证和认知反转，先找最强证据，再决定开场方式。",
    category: "美妆眼妆",
    topics: ["化妆师推荐的眼线铅笔！！真的好用到哭！ #全包眼线 #半包眼线#那柚#眼线铅笔 #眼线…","还真让我遇到能吃能吐的好粉扑了！#粉扑 #底妆 #韩女水光肌 #橙棠 #底妆套组","浅眉真的画一次就爱上！！！深发黄皮姐妹一定要试试柔光灰棕 显白又高级！#木柯诗双…"],
    size: "6.4 MB",
    accent: "lavender",
  },
  {
    date: "2026-09-07",
    title: "家居日用：先替观众质疑，再用实测和数字逐项回答",
    summary: "今天不把这组家居日用压成一种公式，先对照三条真实路径：鉴货严选切丝器的冻肉挑战式质疑、大橙子护腰坐垫的四档价格同框反差、一只小马保鲜袋的180只逐格数清再报价。",
    takeaway: "今天不要从家居日用倒推固定开头：鉴货严选用“把两块冻肉重重放到桌上，挑战‘你把这两块冻肉给我切成丝我看看’”；大橙子用“四款坐垫摆在地上标出39.8到268，口播‘我要说这个便宜的更好用你肯定不信’”；一只小马用“打开套盒依次指出50只小号、100只中号、30只大号”。三条分别依赖挑战质疑、价格反差和数量证据，先找最强证据，再决定开场方式。",
    category: "家居日用",
    topics: ["喜欢做菜不喜欢切菜的可以看看看这个仿刀切切丝器#测评 #好物推荐 #插丝器 #切丝器","#护腰座椅 贵的真的不一定坐着舒服 #人体工学椅 #哺乳期 #孕期 #带娃好物","巴巴爸爸保鲜膜组和到手一百八十只超级划算，大中小三个尺寸"],
    size: "4.4 MB",
    accent: "lime",
  },
  {
    date: "2026-09-08",
    title: "食品零食：先用反常开场圈住人，再让画面和证据接住",
    summary: "今天不把这组食品零食压成一种公式，先对照三条真实路径：小怪零食轻食千层吐司的调侃式薅羊毛开场、我爸超帅教师节礼盒的后台催上式回应、文竹呀树枝法棍的孩子命名“人类猫条”。",
    takeaway: "今天不要从食品零食倒推固定开头：小怪零食轻食用“我看还有哪个小傻瓜不薅这个三只松鼠的大羊毛”；我爸超帅用“开学就是教师节了，后台家长们一直在催我上这个”；文竹呀用“我儿子说它就是人类猫条”。三条分别依赖同伴压力、节点需求和趣味命名，先找最强证据，再决定开场方式。",
    category: "食品零食",
    topics: ["怎么会有这么好吃的千层牛乳吐司！软乎乎，湿润绵软还能一层一层的撕着吃#牛乳千层…","#西塔 这个礼盒是少有的没有家长感的礼物，可爱的就像小朋友自己精心设计挑选自己做…","本来是我看超火买来尝鲜的树枝法棍面包，没想到我儿子吃上瘾了！说比普通的恰巴塔好…"],
    size: "5.3 MB",
    accent: "blue",
  },
  {
    date: "2026-09-09",
    title: "营养滋补：先让观众对号入座，再把变化讲成可感状态",
    summary: "今天不把这组营养滋补压成一种公式，先对照三条真实路径：柚子yo鲜炖燕窝的月薪门槛反差、张蕾益生菌的75岁妈妈真实出镜、亿个亿三蒸三晒红枣的教程先行。",
    takeaway: "今天不要从营养滋补倒推固定开头：柚子yo用“反问‘谁说月薪3500不能吃燕窝’，满盒实物贴近镜头”；张蕾用“镜头转向在屋里舒展身体的妈妈，称她是‘75岁的少女’”；亿个亿用“满锅红枣和蒸汽，画面连续标出‘一蒸去燥、二蒸出胶、三蒸锁红’”。三条分别依赖收入反差、真实状态和教程证据，先找最强证据，再决定开场方式。",
    category: "营养滋补",
    topics: ["如果我不说，谁能看出来我妈都70多岁了…… #张蕾 #张蕾妈妈 #母女 #保养 #万益蓝50益…","月薪3000也能实现的燕窝自由！现在还能拍就别犹豫，给自己、送人，这波羊毛必须薅！…","复刻成功！三蒸三晒红枣软糯甜香～ #红枣的神仙吃法 #喜纯三蒸三晒红枣 #养生零食"],
    size: "4.8 MB",
    accent: "peach",
  },
  {
    date: "2026-09-10",
    title: "图书文具：先把书页和内容拍实，让证明发生在第一屏",
    summary: "今天不把这组图书文具压成一种公式，先对照三条真实路径：一慧书单剖面图科普的第一屏硬核内页、精选伴读好书考点书的出生年份精确点名、小小明同学仔书夹的孩子现身说法。",
    takeaway: "今天不要从图书文具倒推固定开头：一慧书单用“第一屏直接展示扶梯内部剖面图，连续切到空调、电梯和高铁结构”；精选伴读好书用“连续重复‘14、15年出生，9月份上六年级的孩子’，并称最幸运一届”；小小明同学仔用“孩子趴在桌前抱怨‘你要是早点给我准备这个宝贝书架，我也不至于伸长脖子压着书写作业’”。三条分别依赖视觉冲击、身份点名和真实抱怨，先找最强证据，再决定开场方式。",
    category: "图书文具",
    topics: ["近百种科技事物完整拆解、五百多张剖面示意图步骤清晰直白，不需要家长额外查资料， …","从小用到六年级，一本搞定小学六年语数英核心考点，真的太实用了","一款可以解放双手的宝盖头书夹，可固定书本书页，可以12°倾斜站立，像个简易书架一样…"],
    size: "4.5 MB",
    accent: "lavender",
  },
  {
    date: "2026-09-11",
    title: "母婴儿童：把开学和日常痛点演成场景，再让产品进场解决",
    summary: "今天不把这组母婴儿童压成一种公式，先对照三条真实路径：希希妈妈湿巾的食堂借东西尴尬、懒懒不懒星星牙膏的两分钟可见计时、幼稚园小霸王洁面乳的开学禁用警告。",
    takeaway: "今天不要从母婴儿童倒推固定开头：希希妈妈用“食堂里演孩子对话‘你妈没给你买吗？天天找我借，真讨厌’”；懒懒不懒用“把星星膏体挤到刷头上，刷够两分钟才融化”；幼稚园小霸王用“开学准备洗面奶的妈妈们注意了，千万不要再给孩子乱用大人的洗面奶”。三条分别依赖社交尴尬、可见反馈和禁用警告，先找最强证据，再决定开场方式。",
    category: "母婴儿童",
    topics: ["在学校擦嘴擦手擦课桌文具啥的，没有哪一天不需要用的，没想到德佑尊享款桃叶湿巾也…","我儿子说这才是他想要的牙膏！#儿童牙膏 #bop星星牙膏 #孩子不爱刷牙怎么办","#青少年洗面奶 别再给孩子用大人的洗面奶了，孩子皮肤油脂分泌旺盛，小脸变得粗糙…"],
    size: "5.9 MB",
    accent: "lime",
  },
  {
    date: "2026-09-12",
    title: "个护家清：先用反话和麻烦圈住人，再让动作和结果作答",
    summary: "今天不把这组个护家清压成一种公式，先对照三条真实路径：QQ·焯耀美白面膜的反话夸效果、橘洛艺洗发水的“千万别用”禁止句、安北北北冰美式面膜的撕纸顺序两难提问。",
    takeaway: "今天不要从个护家清倒推固定开头：QQ·焯耀用“你要是嫌它白得太快了，你就三天敷一次”；橘洛艺用“头发容易油、容易塌，姐妹们千万别用这款洗发水”；安北北北用“你们敷面膜是先把那张纸撕下来再贴，还是先敷上再撕”。三条分别依赖反话暗示、禁止句冲突和两难提问，先找最强证据，再决定开场方式。",
    category: "个护家清",
    topics: ["美白淡斑面膜欧诗漫","夏伯雅莲洗发水真的太好用啦！妆容很美 发丝不能拖后腿哦～ #夏伯雅莲洗发水 #洗发水 …","可以敷的冰美式！还自带眼贴鼻贴…简直是熬大夜的底气！巨好用！还有试用一片你们快…"],
    size: "4.9 MB",
    accent: "blue",
  },
  {
    date: "2026-09-13",
    title: "美妆彩妆：把吃粉、卡粉和配色焦虑做成可复核的现场实验",
    summary: "今天不把这组美妆彩妆压成一种公式，先对照三条真实路径：张张张不凡骂粉扑商家的多机位吃粉测试、韩大人素颜自曝毛孔的错误底妆示范、苏吧啦把依兰香三调讲成感情阶段。",
    takeaway: "今天不要从美妆彩妆倒推固定开头：张张张不凡用“你试尿不湿得了，尿不湿都没你这么能吸”；韩大人用“我学一下你们是怎么化底妆的”素颜大特写；苏吧啦用“这三个小样是送的，这个是我在闺蜜包里顺的”。三条分别依赖骂点实验、错误示范和活人细节，先找最强证据，再决定开场方式。",
    category: "美妆彩妆",
    topics: ["现在的商家是演都不演了是吗？！#粉扑测评 #粉扑 #底妆 #荔树","画好底妆真的很重要 #化妆 #底妆 #jejo妆前乳","高段位撩人于无形，谁懂依兰香的杀伤力，暧昧，拉扯感满满#香水 #约会神器 #拂若里 #…"],
    size: "7.7 MB",
    accent: "peach",
  },
  {
    date: "2026-09-14",
    title: "家居日用：同一件产品两种开场，实测和踩坑链替参数作答",
    summary: "今天不把这组家居日用压成一种公式，先对照三条真实路径：阿欧收纳好物与叮咚的缝隙刷同品双开场、是小雪呀与小鱼吖的保鲜袋场景对数量、匠小虎测评和商家噩梦借卖家秀做逐步加难的实测。",
    takeaway: "今天不要从家居日用倒推固定开头：阿欧收纳好物用“家里有老人要注意了”圈弯腰费劲的人；小鱼吖用“30多到手100只的时候已经觉得很划算了，没想到现在这价居然给我180只”做数量锚点；匠小虎测评用“来，咱们一起看个卖家秀，给我整笑了”借怀疑开场。三条分别依赖人群点名、数量反差和卖家秀悬念，先找最强证据，再决定开场方式。",
    category: "家居日用",
    topics: ["卫生间用的人太多，每个星期都要打扫两次，所以这个伸缩小魔刷真的帮了我大忙，不用…","这抹布有点东西！ #丝瓜抹布 #测评#厨房抹布推荐","贵的真的不一定坐着舒服 #护腰座椅 #人体工学椅 #哺乳期 #孕期 #带娃好物"],
    size: "5.0 MB",
    accent: "lavender",
  },
  {
    date: "2026-09-15",
    title: "食品零食：送礼先演对话，教程先把成品端上桌",
    summary: "今天不把这组食品零食压成一种公式，先对照三条真实路径：润喉糖借教师节演家庭对话、教室递礼和倒计时三种送法，苹果山楂水用古风师徒和白大褂做同品AI情境变体，炸串夹馍和两款意面把成品和孩子实吃放到第一屏再倒叙步骤。",
    takeaway: "今天不要从食品零食倒推固定开头：大雅说事儿用“今年教师节还想给老师送点这个清润糖”让孩子主动点名；@果果一家人用“还有两天就开学了，叫我再给她炸点串”先交付满盆成品；小川饿不着用“不是50粒，是整瓶100粒”做数量纠正。三条分别依赖送礼场景、成品先行和数量反差，先找最强证据，再决定开场方式。",
    category: "食品零食",
    topics: ["教师节送什么合适？这个润喉糖又贴心又实用，老师吃的时候还能记起孩子心意#益美滋 …","在家复刻夜市学校门口的炸串夹馍，味道比外面卖的还好吃，自己在家做的干净又卫生#…","搬砖打工人必备的#炫迈口香糖 竟然出咖啡味了！！浓厚的咖啡香＋薄荷味太上头了，真…"],
    size: "5.9 MB",
    accent: "lime",
  },
  {
    date: "2026-09-16",
    title: "营养滋补：秋燥掉发先点名，原料和冲泡替口播作答",
    summary: "今天不把这组营养滋补压成一种公式，先对照三条真实路径：五黑粉和津液饮品用“秋天猛猛掉”“缺的不是水而是津液”的字幕圈人走沉浸式带货，苹果黄芪膏把一分半家庭熬制做成可保存教程再卖成品，燕窝粥借中秋送礼先用“别送油腻月饼”和豪车礼盒抬高礼品价值。",
    takeaway: "今天不要从营养滋补倒推固定开头：大玉日记用“这个季节你缺的不是水，而是津液”造信息缺口；博宇妈爱食养用“秋燥来了，天天喝水还是干”直接下锅；老刘吃什么用“中秋别送油腻月饼”先否定旧礼物。三条分别依赖反常识字幕、完整做法和排除旧选项，先找最强证据，再决定开场方式。",
    category: "营养滋补",
    topics: ["入秋后落叶纷飞，干啥都不如把这杯五黑粉喝起来~尤其爱晚睡的 #喜纯五黑粉#亲测分享…","秋燥耗人别慌，苹果这样做，老祖宗的润养智慧太权威了#爱自己#喜纯苹果黄芪膏#秋季…","别光想着老板！人家老婆孩子可别忘了#燕窝粥 #十二夏天 #十二夏天燕窝粥"],
    size: "4.8 MB",
    accent: "blue",
  },
  {
    date: "2026-09-17",
    title: "图书教辅：考点前置铺满屏，先教用法再卖套装",
    summary: "今天不把这组图书教辅压成一种公式，先对照三条真实路径：学霸速记和四上考点把标满批注的书页直接当内容发布，连报考点让家长自己核对教材同步，薄脆本和阅读架先交付“正确用法”教程或一拉一放的结构演示再带出套装价值，班主任范老师用班主任人设加“二三百分冲650”的分数落差圈住初三焦虑家长。",
    takeaway: "今天不要从图书教辅倒推固定开头：欧老師吖用“观潮考点、繁星考点、现代诗考点”连报篇目；百变小铺用“我发现很多人根本不会正确使用薄脆本”先立错误认知；班主任范老师用“初三最后一年六科都差，如何逆天改命”制造极端落差。三条分别依赖考点前置、纠错钩子和人设焦虑，先找最强证据，再决定开场方式。",
    category: "图书教辅",
    topics: ["#三年级 句子仿写是重难点，准备这本课本金句举一仿三，每天读一读练一练，积累素材…","巴掌大小的阅读架，孩子不管带去学校晨读，还是在家写作业都太方便了！再也不用弯腰…","初三最后一年六科都差，如何逆天改命？#初三学习规划 #中考提分攻略 #初三 #中考复…"],
    size: "4.1 MB",
    accent: "peach",
  },
  {
    date: "2026-09-18",
    title: "母婴宠物：真实状态先出场，成分清单殿后作答",
    summary: "今天不把这组母婴宠物压成一种公式，先对照三条真实路径：窗边小喵喵和三贝喵喵用猫咪独处追问和拟人小剧场把养猫人的情绪先勾住，睡袋、面霜和儿童洗发水借立秋降温和“三天没洗头”的真实状态先给证据再讲成分，开学早餐的汉堡、吐司和DHA软糖让孩子实吃画面和掰开断面先证明好吃。",
    takeaway: "今天不要从母婴宠物倒推固定开头：宁小雪的朋友圈用“这是我三天没洗头的状态”先晒真实；佐佑妈咪用“有券”“支付大 bug”连喊制造紧迫；窗边小喵喵用“把猫独自在家一整天到底残忍吗”抛出道德追问。三条分别依赖真实状态、价格紧迫和情绪悬念，先找最强证据，再决定开场方式。",
    category: "母婴宠物",
    topics: ["也没人告诉我小孩洗发水这么好用啊 #贝德美 #儿童洗发水","下周大降温了，给娃回购了#bebebus睡袋 羊毛的软软糯糯的手感好还颜值高，穿上一觉…","#你是你家猫咪专属陪玩师吗 #布偶奇遇记 #布偶猫小剧场 #养猫人的上下班 #布偶小黄鸭"],
    size: "5.1 MB",
    accent: "lavender",
  },
  {
    date: "2026-09-19",
    title: "个护家清：价格锚点先砸下来，卖点全部交给画面演示",
    summary: "今天不把这组个护家清压成一种公式，先对照三条真实路径：抽纸、牙刷囤货盘用整箱开箱加“源头工厂没那么贵”的价格锚点开抢，卸妆膏、蓬松水和发胶把乳化、抓揉、一梳一喷全部落成可视化动作，奶酪杀蟑饵剂用猎奇造型加“一掰一丢”的动作演示把灭蟑讲成全家团灭。",
    takeaway: "今天不要从个护家清倒推固定开头：标扑精选用“在外面十几块钱买一支”立价格锚点；董赫用“你要是用完牙还黄嘴还臭，你基本上告别牙膏吧”下绝对断言；粥粥崽吖用“就这么一个小奶酪，全家蟑螂都得团灭”给结果承诺。三条分别依赖价格对比、挑衅断言和猎奇演示，先找最强证据，再决定开场方式。",
    category: "个护家清",
    topics: ["整箱囤货超划算！4层加厚印花卫生纸 #卫生纸 #居家囤货 #卷纸","好用！好用！推荐~#usmile焕白清新牙膏 #usmile香水牙膏","一掰一丢全家蟑螂都消失！ 拜耳拜灭士新出的奶酪杀蟑饵剂蟑螂更爱吃了！！真的要试…"],
    size: "7.0 MB",
    accent: "lime",
  },
  {
    date: "2026-09-20",
    title: "彩妆：人群痛点先点名，上脸对比当场兑现",
    summary: "今天不把这组彩妆压成一种公式，先对照三条真实路径：腮红高光、染眉膏和修容棒把“123扫到颧骨”“眉头往上眉尾顺毛流”讲成手残党能抄的口诀动作，粉饼、高光棒用“你买错系列了”“不是技术问题是你没用这个”的纠错悬念先立靶再给答案，5毛钱睫毛和美嘉古早大眼靠价格反差和角色记忆撬动低粉流量。",
    takeaway: "今天不要从彩妆倒推固定开头：蒜香小板用“这种裸色真的跟别的不一样”靠审美自信收口；先赚一百万用“终于知道美嘉那种古早大眼美女妆效是怎么画出来的了”借角色记忆揭秘；是范姐用“真不是技术问题，而是你没有用这种嘭嘭霜”替观众卸下自责。三条分别依赖审美断言、情怀记忆和痛点重构，先找最强证据，再决定开场方式。",
    category: "彩妆",
    topics: ["黄皮涂这支冷调裸棕真的很高级！ #唇釉试色 #口红试色 #花洛莉亚唇霜#花洛莉亚酥皮唇霜","真的真的不会晕染！！#古早烟熏妆 #小烟熏 #那柚眼线铅笔 #新手眼线笔","妈生阴影感的双头修容棒，新手随便画！ #修容教程 #修容 #原色波塔修容"],
    size: "6.4 MB",
    accent: "blue",
  },  {
    date: "2026-09-21",
    title: "家居日用：节点、恐慌与说不出口的痛点，三条开场路径",
    summary: "今天不把这组家居日用小爆品压成一种公式，先对照三条真实路径：筱米同学三条春秋被靠降温换季节点质问开场，铺量做基本盘；味见人间用合金筷烧化、竹木筷发霉的破坏性测试先立恐慌再推景德镇陶瓷筷；阿欧收纳好物和游鱼Smile生活把马桶垫、护腰这类说不出口的痛点直接说出口。",
    takeaway: "今天不要从家居日用倒推固定开头：筱米同学用“都立秋了，你不会还在盖那拔凉的夏凉被吧”；阿欧收纳好物用“老公站着不容易弄到”；星星好物分享用“今天下班回家整个房间都是桂花的味道”。三条分别依赖换季节点、痛点直说和隔夜留香的时间差证据，先找最强证据，再决定开场方式。",
    category: "家居日用",
    topics: [
      "手端点燃蜡烛怼近镜头：“昨天晚上点了下，今天下班回家整个房间都是桂花的味道”",
      "合金筷插进烧红炭灰：“合金筷会融化、竹木筷发霉”",
      "大字幕开场：“32岁早上7点起来，睡醒腰像散架一样”",
    ],
    size: "5.6 MB",
    accent: "peach",
  },
  {
    date: "2026-09-22",
    title: "零食饮品：复购对话开场，掰开截面当证据",
    summary: "今天不把这组零食饮品压成一种公式，先对照三条真实路径：煮夫阿峰、乔月轻食零食和二姐超会吃用孩子催买、成箱搬回家的复购小剧场开场；黏人美姐、王三杯呀和紫文家直接掰开贝果、冰皮饼和黑巧，让馅料截面当主角；大馋丫头把临期瑕疵主动说出口，用坦白换信任。",
    takeaway: "今天不要从零食饮品倒推固定开头：煮夫阿峰用“这个卤牛腱子肉你再不给妹妹买两包吧”；二姐超会吃用“好，又拉了，又拍了两箱”；大馋丫头用“牛肉干就是要吃这种临期的”。三条分别依赖复购对话、截面证据和坦白瑕疵，先找最强证据，再决定开场方式。",
    category: "零食饮品",
    topics: [
      "#幸福口袋#温州卤牛腱肉 配料表干净，全家老少都爱吃#好吃到停不下来",
      "每一口都能吃到喷香的黑芝麻内馅儿，绿野麦踪的#黑芝麻贝果 我真的要推荐给每一个#…",
      "临期清仓内蒙古牛肉干，价格夯爆了#牛肉干#内蒙古牛肉干#零食#追剧零食",
    ],
    size: "6.0 MB",
    accent: "lime",
  },
  {
    date: "2026-09-23",
    title: "滋补节礼：长辈点名拒绝月饼，替代品当场举证",
    summary: "今天不把这组滋补节礼压成一种公式，先对照三条真实路径：花姐是超人、潼潼妈和大佑家让长辈亲口说“别送月饼了”，燕窝枇杷烤梨顺势成为替代答案；番茄泡大虾和大师兄MB直接对预算紧的健身人喊“天亮了”；静静妈会食养和布丁酱用季节痛点字幕加原料成品同框完成静默种草。",
    takeaway: "今天不要从滋补节礼倒推固定开头：花姐是超人用“今年中秋不要送月饼了，她就爱吃这燕窝枇杷烤梨”；番茄泡大虾用“手头紧又想喝好的蛋白粉的bro，这下是真的天亮了”；静静妈会食养用“秋季掉发饮”字幕点题。三条分别依赖长辈点名替代、人群困境直呼和季节痛点同框，先找最强证据，再决定开场方式。",
    category: "滋补养生",
    topics: [
      "燕窝枇杷烤梨太适合秋天了，中秋节看爸妈刚好带上#中秋礼盒#中秋#燕窝枇杷烤梨#烤梨…",
      "健身的兄弟这下是真的天亮了 #ON黑标乳清#ON黑标#蛋白粉#健身补剂#补剂",
      "秋天猛猛落的季节，早餐真可以多喝这杯五黑饮，好喝营养，全家都能喝#亲测分享#早餐…",
    ],
    size: "5.4 MB",
    accent: "blue",
  },
  {
    date: "2026-09-24",
    title: "图书教辅：把题目和问题前置，让书自己当证据",
    summary: "今天不把这组图书教辅压成一种公式，先对照三条真实路径：徐多多同学和米诺的学习日记把“猜猜他是谁”这类具体作文题前置，直接翻开对应范文页；嘉良科技龙龙用“故宫里为什么没有厕所”这种问题勾住家长；秋瞳和王老師数学思维用“天地人你我他”“每天1道压轴题”把内容拆成可执行的小动作。",
    takeaway: "今天不要从图书教辅倒推固定开头：徐多多同学用“猜猜他是谁”作文题配范文页；嘉良科技龙龙用“故宫里为什么没有厕所”；王老師数学思维用“每天1道压轴题”。三条分别依赖具体题目、好奇问题和可执行小计划，先找最强证据，再决定开场方式。",
    category: "图书教辅",
    topics: [
      "“现在的绘本、明朝课本、百年前老课本”并排对照",
      "孩子口吻开场：“刚上三年级，第一单元要写猜猜他是谁”",
      "“打不开格局看秦始皇、天生自卑看刘邦、讨好型人格看朱元璋”",
    ],
    size: "4.3 MB",
    accent: "lavender",
  },
  {
    date: "2026-09-25",
    title: "母婴宠物：让家人和宠物先出场，把产品藏进日常",
    summary: "今天不把这组母婴宠物压成一种公式，先对照三条真实路径：爱吃麻辣烫和夏一乐呀用“再买两瓶”“买的这个有点东西”这类家人对话开场；司柠家水族器材和👑依诺妈咪👑用“谁还湿手擦鱼缸”“洗完澡一冷一热”把痛点说破再演示；萌喵叫钢镚、边牧贝拉和小雕是只猫让宠物直接出镜，用喂食和反问完成种草。",
    takeaway: "今天不要从母婴宠物倒推固定开头：爱吃麻辣烫用“孩子对妈妈说再买两瓶”；司柠家水族器材用“谁还湿手擦鱼缸、捞刷子”；萌喵叫钢镚用“早晨6:30”的喂食近景。三条分别依赖家人对话、痛点演示和宠物日常，先找最强证据，再决定开场方式。",
    category: "母婴宠物",
    topics: [
      "孩子对妈妈说“再买两瓶”，把脸部变化递到镜头前",
      "“谁还湿手擦鱼缸、捞刷子”，举起磁力刷",
      "狗狗“羊羊羊”出镜，给猫鲜粮做广告",
    ],
    size: "5.1 MB",
