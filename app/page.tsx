...
const ISSUES: Issue[] = [
  ...
  {
    date: "2026-08-29",
    title: "个护家清：先把看不见的脏拍出来，再让真身作证",
    summary:
      "今天不把这组个护家清压成一种公式，先对照三条真实路径：喜欢喝ad管道泡泡粉的脏泡沫可视化、有几片芝士卫生巾的反常画面加私密点名、吴柳芳牙膏的冠军身份长故事。",
    takeaway:
      "今天不要从个护家清倒推固定开头：喜欢喝ad用「蓝色粉剂倒进白色洗手池，污垢被大片褐色泡沫翻出来，口播“终于知道我们家洗手池的臭味来源了”」；有几片芝士用「菜刀劈开像西瓜的大块冰冻物，口播却直接说“我猜你月经快来了吧”」；吴柳芳用「先放体操赛场旧画面，再切到真人躺在31枚奖牌中间自报“练了15年体操，拿过31枚奖牌”」。三条分别依赖脏污可视化、模式打断和身份故事，先找最强证据，再决定开场方式。",
    category: "个护家清",
    topics: [
  ...
  {
    date: "2026-08-30",
    title: "美妆护肤：先把错误画在脸上，再让产品收场",
    summary: "今天不把这组美妆护肤压成一种公式，先对照三条真实路径：晗晗种草记修容粉的当场纠错教学、是楠楠呀妆前乳的真实人设反差、章鱼腮红的一扫多用动作钩。",
    takeaway: "今天不要从美妆护肤倒推固定开头：晗晗种草记修容粉用“双手夹在鼻子两侧，口播纠正‘修鼻影不是颜色越重越立体’”；是楠楠呀妆前乳用“开车、服装店、完妆和素颜大脸快切，自报‘180斤服装店老板教你们低成本变好看’”；章鱼腮红用“大刷子在单侧颌骨一扫，口播‘就这么一扫，高光腮红一起上’”。三条分别依赖当场纠错、真实人设和动作证明，先找最强证据，再决定开场方式。",
    category: "美妆护肤",
    topics: ["早八手残党再也不用费劲画眼影啦！完美日记三色眼影棒，渐变三色提前搭配好，一笔成…","拒绝假白！被问n次的黄黑皮粉底液#黄黑皮 #亚裔妆 #黄黑皮粉底液 #遮瑕粉底液","妈生肉感嘟嘟唇这么简单就被我画出来了！ #口红种草 #酵色 #唇线笔 #唇线 #唇线笔教程"],
    size: "5.4 MB",
    accent: "lime",
  },
  {
    date: "2026-08-31",
    title: "家居日用：先接住吐槽，再让复测和底价说话",
    summary: "今天不把这组家居日用压成一种公式，先对照三条真实路径：小胖墩躲猫猫小夜灯的吐槽式反转、谢中堡床垫的上月反馈复测、我爱做饭辣小娘炒锅的清仓聊天式带货。",
    takeaway: "今天不要从家居日用倒推固定开头：小胖墩躲猫猫小夜灯用“木纹盒子摆在镜头中央，字幕写‘网友：这不就是个破盒子嘛’，随后小猫灯从盒里探头”；谢中堡床垫用“宿舍床架上摊开整张床垫，口播‘上个月测了他家的五厘米，差点意思，和商家反馈了缺点’”；我爱做饭炒锅用“两只红色炒锅并排放上台面，口播‘昨天他问还有四百多个，我说九十九干不干’”。三条分别依赖吐槽反转、追踪复测和清仓闲聊，先找最强证据，再决定开场方式。",
    category: "家居日用",
    topics: ["躲猫猫小夜灯适合睡前开着，柔和又安心 第24款 #躲猫猫 #躲猫猫144","华娜朵测评后续～7cm宿舍床垫测评 上个月的测评反馈来了，后面我还会更新他家的六七…","辣小娘无涂层炒锅清库存，全部99一个送玻璃盖，拼手速吧！"],
    size: "4.6 MB",
    accent: "blue",
  },
  {
    date: "2026-09-01",
    title: "食品零食：先站队筛人，再把馋感拍满",
    summary: "今天不把这组食品零食压成一种公式，先对照三条真实路径：任心之脱脂牛奶的先贬后夸反转、呆熊科普襄阳牛肉面的争议答疑、拌饭康师傅香菜面的口味站队筛人。",
    takeaway: "今天不要从食品零食倒推固定开头：任心之脱脂牛奶用“冰镇牛奶罐贴到镜头前，边倒奶边说‘切，不就是没有脂肪的纯牛奶’”；呆熊科普牛肉面用“工厂生产线和面饼加工近景，口播‘你可能听说过方便面是垃圾食品这种说法’”；拌饭香菜面用“满杯香菜面和红亮汤底近景，直接说‘不爱吃香菜的划走’”。三条分别依赖态度反转、争议答疑和口味站队，先找最强证据，再决定开场方式。",
    category: "食品零食",
    topics: ["蓝莓水晶皮月饼，外皮糯叽叽，内陷满满的蓝莓流心，好吃到无语！！还没吃过的蓝莓脑…","吃腻一般的普通泡面，那就试试这个正宗的需要牛肉面吧#好吃又方便的面 #泡面#襄阳牛…","香菜脑袋看过来，康师傅新出的真香香菜面，劲道面条吸满辣牛肉汤底，吃一口香迷糊了…"],
    size: "6.1 MB",
    accent: "peach",
  },
  {
    date: "2026-09-02",
    title: "健康养生：先点名你的状态，再让过程作证",
    summary: "今天不把这组健康养生压成一种公式，先对照三条真实路径：Joe的食谱五黑膏的复杂自制证明价值、高志凯氨糖的名人身份加事故故事、王微斯补铁软糖的自嘲表演对号入座。",
    takeaway: "今天不要从健康养生倒推固定开头：Joe的食谱五黑膏用“一边搅动砂锅里的深色膏体，一边问‘立秋过后，有没有跟我一样不到2点不肯睡的’”；高志凯氨糖用“真人正坐出镜先报姓名，再问‘很多人问我为什么选进口的氨糖软骨素，难道进口的就更好吗’”；王微斯补铁用“边吃软糖边演‘低精力女生的每天’，连续切有点冷、有点烦、站不稳的夸张动作”。三条分别依赖过程证据、身份故事和自嘲表演，先找最强证据，再决定开场方式。",
    category: "健康养生",
    topics: ["自制黄精五黑膏🍃 秋养黄金期，想要好好养好自己毛 发的女生，每天一勺黄精五黑膏就够…","我老高今天掏心窝子跟大家说说心里话，腿脚好对生活实在太重要。 #膝盖 #益节氨糖…","真的很想把高精力人群磨成粉喝了 #撑不住了#我的精神状态belike#fiboo元气铁"],
    size: "5.3 MB",
    accent: "lavender",
  },
  {
    date: "2026-09-03",
    title: "开学图书文具：命令式开场加具体动作，先圈家长再给方案",
    summary: "今天不把这组开学图书文具压成一种公式，先对照三条真实路径：智谋贝贝卡书屋文脉里的中国的命令式年级点名、与时文化饭局接话的情景剧演示、载望图书周测卷的结果加照抄计划。",
    takeaway: "今天不要从开学图书文具倒推固定开头：智谋贝贝卡书屋用“竖起两根手指说‘进入二年级，一定要每天晚上看一页《文脉里的中国》’，随后马上把书举到镜头前”；与时文化用“饭局上被刁难‘来这么晚只能吃剩菜了吧’，马上回答‘饭在哪我都能吃，但您这桌不是谁想坐就能坐的’”；载望图书用“校园外景上直接打出‘初一10点睡、成绩第一的秘诀抓周末，没有计划的直接抄’”。三条分别依赖命令式安排、情景剧冲突和结果加计划，先找最强证据，再决定开场方式。",
    category: "开学图书文具",
    topics: ["放下手机，让孩子看文脉里的中国，孩子变得主动思考了#孩子教育#儿童益智#好书推荐#…","当你学会职场上的高情商接话 #高情商#职场生存法则#内容过于真实","别忽视初一基础！每周一套自测卷，检验课堂掌握情况，及时补齐薄弱点，避免差距越拉…"],
    size: "5.2 MB",
    accent: "lime",
  },
];
